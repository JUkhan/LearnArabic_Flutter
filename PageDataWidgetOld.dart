    ...
    for (var l in line.lines) {
      ...
      if (line.lineno == 1) {
        spans.add(TextSpan(
            ...
            style: Util.getTextTheme(context, 'ltr', _memo.fontSize)));
      }
      //before
      if (line.mode == 'b') {
        spans.add(TextSpan(
            text: '..........' + wordSpace,
            style: Util.getTextTheme(context, line.direction, _memo.fontSize)));
      }
      spans.addAll(
  ...
  TextSpan _getTextSpan(JWord word, String direction) {
    ...
    return TextSpan(
        style: hasSelectedWord(word.id)
            ? Util.getTextTheme(context, direction, _memo.fontSize).copyWith(
                shadows: [
                  Shadow(
            ...
            : Util.getTextTheme(context, direction, _memo.fontSize),
        children: txtSpans);
  }
